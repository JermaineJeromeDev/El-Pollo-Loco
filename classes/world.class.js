class World {
    ...
    backgroundObjects = [
        ...
        new BackgroundObject('assets/img/5_background/layers/3_third_layer/1.png', -720 * 3),
        new BackgroundObject('assets/img/5_background/layers/2_second_layer/1.png', -720 * 3),
